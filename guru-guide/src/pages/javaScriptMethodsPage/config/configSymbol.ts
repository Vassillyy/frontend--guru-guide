...
export const configSymbol = {
  [Sections.SYMBOL]: [
    ...
    },
    {
      ...
      example: "const sym1 = Symbol.for('app');\nconst sym2 = Symbol.for('app');\nconsole.log(sym1 === sym2); // true",
      specification:
