export const configPromise = {
  PROMISE: [
    ...
    },
    {
      ...
      example: "const promise = new Promise((resolve, reject) => reject(new Error('Failed!')));\npromise.catch((error) => {\n console.log(error.message); // 'Failed!'\n});",
    ...
    },
    {
      ...
      example: "const promise = Promise.resolve(42);\npromise.then((value) => {\n console.log(value); // 42\n});",
    ...
    },
    {
      ...
      example: "const promise = Promise.reject('Some error');\npromise.catch((error) => {\n console.log(error); // 'Some error'\n});",
