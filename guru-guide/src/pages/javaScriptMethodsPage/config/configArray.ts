export const configArray = {
  ARRAY: [
    ...
    },
    {
      ...
      example: "const data = ['apple', 'banana', 'orange'];\nconst str = data.toString();\nconsole.log(str); // 'apple,banana,orange'",
      specification:
